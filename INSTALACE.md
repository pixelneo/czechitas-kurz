...
2. Stáhni si instalaci jazyka Python z [tohoto odkazu](https://www.python.org/ftp/python/3.9.10/python-3.9.10-amd64.exe). Stažený soubor spusť. Rozběhne se průvodce instalací. *Pokud by ti tato verze Pythonu nefungovala, vyzkoušej nějakou nižší verzi (3.7, 3.6,...).*
